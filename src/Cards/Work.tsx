    ...
    return (
        <div className="w-full h-full rounded-[32px] border-[16px] border-zinc-900 overflow-clip text-md">
            <div className="relative bg-white rounded-[16px] w-full h-full overflow-clip">
                ...
                {/* Links */}
                <div className="absolute right-4 bottom-8 flex justify-center text-sm font-bold text-center space-x-[12px]">
                    <div className={`z-2 px-4 py-3 text-white bg-black rounded-[12px] transition-all duration-700 delay-[1500ms] hover:scale-[1.1] ${active ? "opacity-1 translate-y-0" : "opacity-0 translate-y-4 delay-[500ms]"}`}>
                        <a href="https://drive.google.com/file/d/1Pc_ZWn1-vfx9i-4YlUIGNEHIygTR3LUh/view?usp=sharing" target={"_blank"} rel={"noreferrer"}>Resume</a>
                    </div>
                    <div className={`z-2 px-4 py-3 text-white bg-black rounded-[12px] transition-all duration-700 delay-[1750ms] hover:scale-[1.1] ${active ? "opacity-1 translate-y-0" : "opacity-0 translate-y-4 delay-[500ms]"}`}>
                        <a href="https://drive.google.com/file/d/1o1J2pIsJKufgPtdr7QrG8RNJLERFkNRg/view?usp=sharing" target={"_blank"} rel={"noreferrer"}>Cover Letter</a>
                    </div>
                </div>
            </div>
        </div>);
